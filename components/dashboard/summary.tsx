...
const SummaryCard: React.FC<SummaryCardProps> = ({
  ...
  return (
    <div
      className="p-6 rounded-md flex-auto
 dark:bg-blue-900 bg-slate-200 border"
    >
      <div
        className="flex items-center
     gap-5 justify-center max-md:justify-between "
      >
        <div>
          <p> {title}</p>
      ...
      <div
        className={`flex gap-1 mt-4 md:justify-center ${
